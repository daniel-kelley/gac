...
send "/top/lookup1/index1_idx_scale" 0
...
toggle "/top/lookup1/set"
send "/top/lookup1/index1_idx_scale" 1

send "/top/lookup2/index1_idx_scale" 0
...
toggle "/top/lookup2/set"
send "/top/lookup2/index1_idx_scale" 1

send "/top/index1/glock1" 1
send "/top/index1/len" 4

send "/top/osc1/lookup1_freq_scale" 1
send "/top/osc1/lookup2_shape_scale" 1

send "/top/glock1/freq" 4
send "/top/glock1/ena" 1
...
send "/top/osh1/glock1" 1

send "/top/amp1/osc1" 1
send "/top/amp1/ar1_gain_scale" 1
